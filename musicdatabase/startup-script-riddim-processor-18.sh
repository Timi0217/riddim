#!/bin/bash
echo "🚀 Starting RIDDIM processor: riddim-processor-18"
echo "📊 Processing ranks 851-900"
...
echo "🎵 Processing ranks 851 to 900"
python3 riddim_batch_processor.py     --manifest afrobeats_intelligence_20250717_103640_manifest.json     --start-rank 851     --end-rank 900     --batch-size 50     > /var/log/riddim_processor.log 2>&1

# Log completion
echo "✅ COMPLETE: Processed ranks 851-900" >> /var/log/riddim_processor.log
echo "done-851-900" > /tmp/riddim_complete
