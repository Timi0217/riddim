#!/bin/bash
echo "🚀 Starting RIDDIM processor: riddim-processor-20"
echo "📊 Processing ranks 951-1000"
...
echo "🎵 Processing ranks 951 to 1000"
python3 riddim_batch_processor.py     --manifest afrobeats_intelligence_20250717_103640_manifest.json     --start-rank 951     --end-rank 1000     --batch-size 50     > /var/log/riddim_processor.log 2>&1

# Log completion
echo "✅ COMPLETE: Processed ranks 951-1000" >> /var/log/riddim_processor.log
echo "done-951-1000" > /tmp/riddim_complete
