#!/bin/bash
echo "🚀 Starting RIDDIM processor: riddim-processor-16"
echo "📊 Processing ranks 751-800"
...
echo "🎵 Processing ranks 751 to 800"
python3 riddim_batch_processor.py     --manifest afrobeats_intelligence_20250717_103640_manifest.json     --start-rank 751     --end-rank 800     --batch-size 50     > /var/log/riddim_processor.log 2>&1

# Log completion
echo "✅ COMPLETE: Processed ranks 751-800" >> /var/log/riddim_processor.log
echo "done-751-800" > /tmp/riddim_complete
