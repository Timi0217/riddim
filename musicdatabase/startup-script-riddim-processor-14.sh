#!/bin/bash
echo "🚀 Starting RIDDIM processor: riddim-processor-14"
echo "📊 Processing ranks 651-700"
...
echo "🎵 Processing ranks 651 to 700"
python3 riddim_batch_processor.py     --manifest afrobeats_intelligence_20250717_103640_manifest.json     --start-rank 651     --end-rank 700     --batch-size 50     > /var/log/riddim_processor.log 2>&1

# Log completion
echo "✅ COMPLETE: Processed ranks 651-700" >> /var/log/riddim_processor.log
echo "done-651-700" > /tmp/riddim_complete
